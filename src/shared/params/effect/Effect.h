...
/*struct EffectData {
	...
	int32_t physicsAttackPower{ 0 };
	int32_t magicAttackPower{ 0 };
	int32_t fireAttackPower{ 0 };
	int32_t thunderAttackPower{ 0 };
	float physicsDiffenceRate{ 1.f };
	float magicDiffenceRate{ 1.f };
	float fireDiffenceRate{ 1.f };
	float thunderDiffenceRate{ 1.f };
	int32_t physicsDiffence{ 0 };
	int32_t magicDiffence{ 0 };
	int32_t fireDiffence{ 0 };
	int32_t thunderDiffence{ 0 };
	float NoGuardDamageRate{ 1.f };
	float vitalSpotChangeRate{ 1.f };
	float normalSpotChangeRate{ 1.f };
	float lookAtTargetPosOffset{ 1.f };
...
// Copied from LibER in order to get default variables
// (I was too lazy :)) -> https://github.com/Dasaav-dsv/libER/blob/d8ae5c92719adca4344d8d902b63286b807f562b/include/param/paramdef/SP_EFFECT_PARAM_ST.hpp
// Extended by info of TGA table
struct EffectData
{
    /**
     * @brief Icon ID
     ...
     * @brief
     *
     * Unknown isHpBurnEffect
     */
    bool isHpBurnEffect : 1 { false };

    bool unknown_0x352_6 : 1 { false };
    bool unknown_0x352_7 : 1 { false };
    bool unknown_0x353_0 : 1 { false };
    bool unknown_0x353_1 : 1 { false };
    bool unknown_0x353_2 : 1 { false };
    bool unknown_0x353_3 : 1 { false };
    bool unknown_0x353_4 : 1 { false };
    uint8_t unknown_0x353_5 : 3 { 0 };
...
static_assert(sizeof(GameEffectData) == 0xD, "Size mismatch!");
